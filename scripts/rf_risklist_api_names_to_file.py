...
# $ python3 ./rf_risklist_api_names_to_csv.py >> ./iprisklist_$(date +"%Y_%m_%d_%H_%M_%S_%s").csv
# INVOKING via CRON: (Apend to existing Suricata dataset)
# 0 06,13 * * * /usr/bin/python3 /development/./rf_risklist_api_names_to_csv.py >> /etc/suricata/rules/ads-ioc-dataset.lst 2> /development/rf_risklist_api_names_to_csv.err.log 1> /development/rf_risklist_api_names_to_csv.log 
...
rf_url = 'https://api.recordedfuture.com/v2/ip/risklist?format=csv%2Fsplunk&gzip=false'
headers = {
